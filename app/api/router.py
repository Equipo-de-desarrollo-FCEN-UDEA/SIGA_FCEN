...
from app.api.routes.v1.users import admin_type
from app.api.routes.v1.users import professor_type
...
api_router.include_router(admin_type.router, prefix="/admin_type", tags=["admin_type"])
api_router.include_router(professor_type.router, prefix="/professor_type", tags=["professor_type"])   
