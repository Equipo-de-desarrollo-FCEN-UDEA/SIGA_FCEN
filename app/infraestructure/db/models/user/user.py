...
class User(BaseModel):
    ...
    # # relations
    roles = relationship("Rol", secondary="user_rol_academic_unit", back_populates="users")
    academic_units = relationship("AcademicUnit", secondary="user_rol_academic_unit", back_populates="users")